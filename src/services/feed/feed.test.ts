...
describe('Проверка слайса feedSlice', () => {
    ...
    it('getIngredients pending', () => {
        const prevState = { ...initialState, feeds: { total: feedState.total, totalToday: feedState.totalToday }, orders: feedState.orders }
    ...
    it('getIngredients fulfilled', () => {
        ...
        expect(state).toEqual({ ...initialState, feeds: { total: feedState.total, totalToday: feedState.totalToday }, orders: feedState.orders });
    })
