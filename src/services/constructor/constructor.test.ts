...
describe('Проверка слайса constructorSlice', () => {
  ...
  it('setIngredient bun', () => {
    const action = {
      ...
      payload: { ...ingredientBun, id: '1' }
    };
    const state = constructorSlice.reducer(initialState, action);
    expect(state).toEqual({
      ...initialState,
      constructorItems: { bun: { ...ingredientBun, id: '1' }, ingredients: [] }
    });
  });
  ...
  it('setIngredient main', () => {
    ...
    expect(state).toEqual({
      ...
      constructorItems: {
        bun: null,
        ingredients: [{ ...ingredientMain, id: '1' }]
      }
    });
  });
  ...
  it('deleteIngredient', () => {
    const prevState = {
      ...initialState,
      constructorItems: { bun: null, ingredients: [ingredientForDelete] }
    };
  ...
  it('DownIngredient', () => {
    ...
    expect(state).toEqual({
      ...initialState,
      constructorItems: { bun: null, ingredients: ingredientsTo }
    });
  });
